...
#1=PRM[8811](#1=主轴刀号) 
#2=#20(#2=要更换的刀号) 
#3=PRM[8813](大刀设置的刀套数量) 
#5=PRM[8812](大换小前记录的主轴刀号，即放入大刀刀套的小刀刀号)
...
[V-27PMC大刀随机刀库（含M11,M12控制信号Y10.1）.zip](https://github.com/user-attachments/files/25085712/V27-PMC-.zip)
